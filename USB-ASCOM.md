...
Version 1.4.4 verwendet das vollständige Prozess-, Klassenfabrik- und
...
3. `Build-Installer.ps1` wie unten ausführen und die neue Setup-EXE **1.4.4** installieren.
...
kompiliert anschließend den Installer. Ausgabe bei Version 1.4.4:

```text
windows\dist\Astro-Orbit-ASCOM-Setup-1.4.4.exe
```
